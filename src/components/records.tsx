...
export function Records() {
  ...
  return <main className="page-frame records-page">
    <header className="page-header"><h1>Records</h1></header>
    ...
    {!loading && <p className="records-note">{`${filteredUpdates.length} of ${updates.length} records match the current filters.`}</p>}
