...
export function StudentProfile({ studentId }: { studentId: string }) {
  ...
  useEffect(() => {
    ...
    async function refreshData() {
      try {
        ...
        console.error("Unable to load Google Sheet profile data", error);
      }
    }
  ...
  if (!student) return <main className="page-frame profile-page"><p className="empty-state">Student data is not available from the Google Sheet.</p></main>;
