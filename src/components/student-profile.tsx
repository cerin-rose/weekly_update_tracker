...
export function StudentProfile({ studentId }: { studentId: string }) {
  ...
  return <main className="page-frame profile-page">
    ...
    <header className="profile-header"><div className="profile-identity"><span className="owner-mark owner-mark-large">{student.initials}</span><div><p className="eyebrow">Student profile</p><h1>{student.name}</h1><p>{student.programAffiliation} · {student.leadershipRole}</p></div></div></header>
