...
export function Dashboard() {
  ...
  return <main className="page-frame dashboard-page">
      <div className="page-intro dashboard-intro">{showDirectory ? <><h1>Student Directory</h1></> : <><h1>Wednesday Review</h1><p className="meeting-line">{meetingDate === "all" ? "All meetings" : formatShortDate(meetingDate)} · {team}</p></>}</div>
